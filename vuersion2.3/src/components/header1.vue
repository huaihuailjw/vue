          ...
          case sortNum == 2:
            ...
            for (let i = 0; i < rateLen; i++) {
              ...
              sales.sort(function (a, b) {
                return b.rateL[1].slice(b.rateL[1].indexOf('售') + 1, b.rateL[1].length - 1) - a.rateL[1].slice(
                  a.rateL[1].indexOf('售') + 1, a.rateL[1].length - 1);
              });
            };
